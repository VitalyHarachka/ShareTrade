 ...
 * 
 */
@WebServiceClient(name = "CurrencyConversionWSService", targetNamespace = "http://DOCwebServices/", wsdlLocation = "http://localhost:9090/CurrencyConvertor/CurrencyConversionWSService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9090/CurrencyConvertor/CurrencyConversionWSService?wsdl");
